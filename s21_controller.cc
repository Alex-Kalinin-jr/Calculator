...
Controller::Controller(Model *entity, CreditModel *cr_entity, DepoModel *d_ent)
...
void Controller::PassDepoInfo(
    const DepoInfo &a, const std::multimap<std::time_t, size_t> rep,
